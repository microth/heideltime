 ...
 *
 */
public class StanfordPOSTaggerWrapperOld extends JCasAnnotator_ImplBase {
	...
	public void process(JCas jcas) throws AnalysisEngineProcessException {
		...
		for(List<HasWord> sentenceToken : tokenArray) {
			...
			for(HasWord wordToken : sentenceToken) {
				...
				if(annotate_tokens) {
					t.addToIndexes();
    				System.err.println("TOKEN: " + (t.getBegin()) + " - " + (t.getEnd())); // TODO:DEBUG
				}
			}
			...
			if(annotate_sentences) {
				...
				System.err.println("SENTENCE: " + (sentence.getBegin()) + " - " + (sentence.getEnd())); // TODO:DEBUG
			}
		}
